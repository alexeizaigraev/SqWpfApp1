...
namespace SqWpfApp1
{
    internal class Pereezd : PapaKabinet
    {
        ...
        public static void MainPereezd()
        {
            ...
            {
                string koatu2 = DbKoatuSpr.MkKoatu2(u[4], u[19], u[7]);
                if (u[2] == "") u[2] = "Київська";
    ...
    ";
                ...
                string ofname = kabinetPath + u[0] + "_pereezd_" + u[10] + ".xml";
        ...
        {
            return DbBase.GetData(@"SELECT terminals.department,
